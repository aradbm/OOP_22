...
public class UndoableStringBuilder {
    ...
    public void undo() {
        try {
            ...
            STR = new StringBuilder("");
            System.err.println("Too many undos! " + e);
        }
    }
    ...
    /**
     * This method delete string in corrent stringbuilder in given range.
     * 
    ...
    /**
     * This method returns string of corrent string builder.
     * 
     * @return corrent string
     */
    @Override
